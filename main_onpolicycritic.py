...
if __name__ == "__main__":
    ...
    args.policy_name == "DDPGOnPolicyCritic"
    ...
    elif args.policy_name == "DDPGOnPolicyCritic": policy = DDPGOnPolicyCritic.DDPG(state_dim, action_dim, max_action, args.larger_critic_approximator)

    replay_buffer = utils.ReplayBuffer()
    onpolicy_replay_buffer = utils.ReplayBuffer()
    ...
    while total_timesteps < args.max_timesteps:
        ...
        if done: 
            ...
            if total_timesteps != 0: 
                ...
                elif args.policy_name == "DDPGOnPolicyCritic":
                    policy.train(replay_buffer, onpolicy_replay_buffer, episode_timesteps, args.repeated_critic_updates, args.critic_repeat, args.batch_size, args.discount, args.tau)
                else: 
        ...
        onpolicy_replay_buffer.add((obs, new_obs, action, reward, done_bool))
        obs = new_obs
