        ...
        def train(self, replay_buffer, iterations, repeated_critic_updates, critic_repeat, batch_size=64, discount=0.99, tau=0.001):
            ...
            for it in range(iterations):
                ...
                #self.critic_optimizer.step()
                    ...
                    #critic_loss += iterations * self.critic_updates(replay_buffer, iterations, batch_size, discount, critic_repeat)
                    #critic_loss /= (iterations + 1)

                critic_loss = self.critic_updates(replay_buffer, iterations, batch_size, discount, critic_repeat)
